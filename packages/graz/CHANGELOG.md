...
- ca26b14: Refactor browser and mobile WalletConnect adapters around shared wallet factories, while preserving account-change subscription cleanup and async mutation callback sequencing.
...
- 821f2e7: Add framework-agnostic wallet event subscriptions and the `useWalletEvents` React hook.
